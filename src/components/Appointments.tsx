...
export const Appointments: React.FC<AppointmentsProps> = ({isDarkMode, language}) => {
    ...
    useEffect(() => {
        const fetchDoctors = async () => {
            setLoading(true);
            try {
                const response = await axios.get<Doctor[]>('http://localhost:8080/api/v1/doctors', {
                    headers: {
                            ...
                            <div className="space-y-4">
                                ...
                                {selectedDate && (
                                    <div>
                                        ...
                                        {Array.isArray(selectedDoctor?.availableSlots) && selectedDoctor.availableSlots.length > 0 ? (
                                            ...
                                            <p className="text-sm text-gray-500 mt-2">Нет доступных слотов</p>
                                        )}
                                    </div>
                                )}
